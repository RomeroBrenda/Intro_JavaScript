...
let color = prompt("Ingresa un color del semaforo (rojo, amarillo o verde): ").toLowerCase;
// toLowerCase() permite que el usuario escriba en mayúsculas o minúsculas y el programa igual funcione.

// Evaluamos el color ingresado utilizando "switch"
switch (color) {
    case "rojo":
